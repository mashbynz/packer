# =============================================================================
# Packer Variables - Windows Server 2022 Core - Print Services Role
# =============================================================================
# Print and Document Services
# Usage: packer build -only="*.printservices" -var-file=examples/printservices.pkrvars.hcl .
#
...
# Output Image
managed_image_name                = "WindowsServer2022-Core-PrintServices"
managed_image_resource_group_name = "packer-rg"
image_name_prefix                 = "VM"

# Server Role
server_role               = "printservices"
