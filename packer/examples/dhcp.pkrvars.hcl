# =============================================================================
# Packer Variables - Windows Server 2022 Core - DHCP Server Role
# =============================================================================
# DHCP Server
# Usage: packer build -only="*.dhcp" -var-file=examples/dhcp.pkrvars.hcl .
#
...
# Output Image
managed_image_name                = "WindowsServer2022-Core-DHCP"
