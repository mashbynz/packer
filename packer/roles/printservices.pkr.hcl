# =============================================================================
# Packer Configuration - Windows Server 2022 Core - Print Services Role
# =============================================================================
# Print and Document Services
# Build: packer build -only="*.printservices" -var-file=examples/printservices.pkrvars.hcl .
# =============================================================================

source "azure-arm" "printservices" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-PrintServices"
...
build {
  ...
  sources = ["source.azure-arm.printservices"]
  ...
  # Step 3: Install Print Services Role
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-PrintServices.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-printservices.json"
    strip_path = true
  }
}
