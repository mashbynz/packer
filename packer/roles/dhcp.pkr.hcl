# =============================================================================
# Packer Configuration - Windows Server 2022 Core - DHCP Server Role
# =============================================================================
# DHCP Server
# Build: packer build -only="*.dhcp" -var-file=examples/dhcp.pkrvars.hcl .
# =============================================================================

source "azure-arm" "dhcp" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-DHCP"
...
build {
  ...
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-DHCP.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-dhcp.json"
    strip_path = true
  }
}
