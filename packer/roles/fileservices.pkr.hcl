# =============================================================================
# Packer Configuration - Windows Server 2022 Core - File Services Role
# =============================================================================
# File and Storage Services
# Build: packer build -only="*.fileservices" -var-file=examples/fileservices.pkrvars.hcl .
# =============================================================================

source "azure-arm" "fileservices" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-FileServices"
...
build {
  ...
  sources = ["source.azure-arm.fileservices"]
  ...
  # Step 3: Install File Services Role
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-FileServices.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-fileservices.json"
    strip_path = true
  }
}
