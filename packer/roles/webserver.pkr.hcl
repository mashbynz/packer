# =============================================================================
# Packer Configuration - Windows Server 2022 Core - Web Server Role
# =============================================================================
# IIS Web Server
# Build: packer build -only="*.webserver" -var-file=examples/webserver.pkrvars.hcl .
# =============================================================================
...
source "azure-arm" "webserver" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-WebServer"
...
build {
  ...
  # Step 3: Install Web Server Role
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-WebServer.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-webserver.json"
    strip_path = true
  }
}
