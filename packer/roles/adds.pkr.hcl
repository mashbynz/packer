# =============================================================================
# Packer Configuration - Windows Server 2022 Core - ADDS Role
# =============================================================================
# Active Directory Domain Services
# Build: packer build -only="*.adds" -var-file=examples/adds.pkrvars.hcl .
# =============================================================================

source "azure-arm" "adds" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-ADDS"
...
build {
  ...
  # Step 3: Install ADDS Role
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-ADDS.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-adds.json"
    strip_path = true
  }
}
