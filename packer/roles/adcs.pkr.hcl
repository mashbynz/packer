# =============================================================================
# Packer Configuration - Windows Server 2022 Core - ADCS Role
# =============================================================================
# Active Directory Certificate Services
# Build: packer build -only="*.adcs" -var-file=examples/adcs.pkrvars.hcl .
# =============================================================================

source "azure-arm" "adcs" {
  ...
  # Output Image
  managed_image_name                = "${var.image_name_prefix}WindowsServer2022-Core-ADCS"
...
build {
  ...
  # Step 3: Install ADCS Role
  provisioner "powershell" {
    script = "${path.root}/scripts/roles/Install-ADCS.ps1"
  }
  ...
  post-processor "manifest" {
    output     = "packer-manifest-adcs.json"
    strip_path = true
  }
}
